...
function TARMINAL_Start(){
	...
	//上のやつを描画
	Window_Contents("<TEXTAREA class=\"hm\" id=\"TARMINAL_TEXTAREA_" + Window_element.ID + "\" style=\"width: 100%; font-size: 50px; height: calc(100% - 100px); resize: none;\">SINOS Term" + TARMINAL_Version + "\n</TEXTAREA><INPUT class=\"hm\" id=\"TERMINAL_INPUT_" + Window_element.ID + "\" style=\"font-size: 50px;\" onkeydown=\"TARMINAL_TEXTINPUT(event, '" + Window_element.ID + "')\">",0,Window_element.ID);
